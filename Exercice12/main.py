...
if __name__ == "__main__":
    library = Library()
    print("livre disponible au démarrage :", library.available_books())
    library.add_book(Book("Le Petit Prince", "Antoine", 2034))
    print("livre disponible apres ajout du Petit Prince :", library.available_books())
